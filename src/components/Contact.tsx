...
export function Contact() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log('The Forest contact request:', formData);
    ...
    <section id="contact" className="section-shell bg-[var(--forest-deep)] text-[var(--forest-ivory)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <p className="kicker kicker-light">Request the brochure</p>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/74">
              If you want pricing, a masterplan walkthrough, or a private discussion, share your
              details and we will respond.
            </p>
            ...
            <div className="mt-10 space-y-4">
              {contactDetails.map((item) => (
                ...
                >
                  ...
                  <span>
                    <span className="block text-xs uppercase tracking-[0.32em] text-white/46">
                      {item.label}
                    </span>
            ...
            <div className="mt-10 rounded-[1.75rem] border border-[rgba(200,165,97,0.18)] bg-[rgba(200,165,97,0.08)] p-5">
              <p className="text-xs uppercase tracking-[0.32em] text-[var(--forest-gold)]/95">
                Private viewings by appointment
              </p>
              <p className="mt-3 text-sm leading-7 text-white/74">
                Response within one business day. The brochure, pricing architecture, and masterplan
                details can be shared once we know what you want to explore.
              </p>
            </div>
          </div>
          ...
          <div className="luxe-card bg-[rgba(247,242,232,0.94)] p-6 text-[var(--forest-deep)] shadow-[0_24px_70px_rgba(15,31,23,0.18)] sm:p-8">
            {isSubmitted ? (
              <div className="flex min-h-[32rem] flex-col items-center justify-center rounded-[1.5rem] border border-[rgba(19,45,36,0.08)] bg-white/65 px-6 py-12 text-center">
                ...
                <h3 className="mt-6 font-serif text-3xl text-[var(--forest-deep)]">Thank you.</h3>
                <p className="mt-3 max-w-md text-sm leading-7 text-[var(--forest-green)]/72">
                  Your request has been received. The team will share the brochure shortly.
                </p>
              </div>
            ) : (
              <form className="space-y-5" onSubmit={handleSubmit}>
                <div>
                  ...
                  <h3 className="mt-4 font-serif text-3xl leading-tight text-[var(--forest-deep)]">
                    Request the brochure.
                  </h3>
                  <p className="mt-4 text-sm leading-7 text-[var(--forest-green)]/72">
                    Share the basics and we will send the right materials.
                  </p>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(event) =>
                        setFormData((current) => ({ ...current, interest: event.target.value }))
                      }
                      className={fieldClass}
                    >
